  ...
  return (
    <div className="my-story">
      ...
      <p>
        ...
        deal with until later in life) and then being bullied at high school was
        to be the start of my mental health journey. Along with this, the
        separation of my parents, reinforced a sense of instability in what was
        otherwise a loving, happy and supportive childhood. From these now shaky
        grounds I became a young single mum, living on my own and having to grow
        up rapidly. These were some of my most difficult years.
      </p>
      <p>
        Following the breakup with my child’s father and having to move to a
        place of safety, it was here where my mental health really took control
        of me. At the age of 18 I started to suffer with anxiety and panic
        attacks daily and to this day now almost 34 years later I still battle
        with this. I become afraid to go out and confrontation was a no no.
      </p>
      <p>
        There were times when trying to buy a tin of beans would present a real
        challenge for me. I had lost all confidence in myself and the world
        around me. I was heavily medicated which just made daily activities even
        more difficult. One day whilst frantically trying to take an
      ...
      <p>
        Setting myself small achievable goals and celebrating the completion of
        them. I completed my degree at university and landed my dream job
        ...
        would need help. This time things were different I was more in control,
